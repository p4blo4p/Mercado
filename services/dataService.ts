...
export const fetchDashboardData = async (
  ...
  try {
    // 1. Try to fetch the static JSON generated by GitHub Actions
    // We add a timestamp query param to bypass browser caching
    ...
    // 2. Map static data to application model
    return METRICS.map((metric) => {
